    ...
    <AuthGuard>
      ...
      >
        ...
        <section className="space-y-4 text-gray-800 text-sm leading-relaxed">
          <p>
            www.ypropel.com constitutes your agreement to all such Terms. Please
            read these terms carefully, and keep a copy of them for your
            reference.
          </p>

          <p>
            <strong>www.ypropel.com is a Social Networking Site.</strong>
          </p>

          <p>
            A professional social networking platform exclusively designed for
            high school and university students embarking on their educational
            and career journeys. Get access to social networking, mentorship,
            educational resources, Jobs & Internship opportunities.
          </p>

          <h2 className="text-xl font-semibold mt-6 mb-2">Privacy</h2>
          <p>
            Your use of www.dolphinselite.com is subject to YPropel&apos;s
          ...
          <p>
            Visiting www.ypropel.com or sending emails to YPropel constitutes
          ...
          <p>
            ...
            entity. You acknowledge that YPropel is not responsible for third
            party access to your account that results from theft or
            misappropriation of your account. YPropel and its associates reserve
            the right to refuse or cancel service, terminate accounts, or remove
            or edit content in our sole discretion.
          </p>

          {/* Add the rest of your terms content here in similar fashion, splitting into paragraphs and headings */}

          <h2 className="text-xl font-semibold mt-6 mb-2">Children Under Thirteen</h2>
          <p>
            YPropel does not knowingly collect, either online or offline,
            personal information from persons under the age of thirteen. If you
            are under 18, you may use www.YPropel.com only with permission of a
            parent or guardian.
          </p>

          <h2 className="text-xl font-semibold mt-6 mb-2">Cancellation/Refund Policy</h2>
          <p>
            You may delete your account at any time. Please contact us at{" "}
            <a href="mailto:romar@ypropel.com" className="text-blue-600 underline">
              romar@ypropel.com
            </a>{" "}
            with any questions.
          </p>

          <h2 className="text-xl font-semibold mt-6 mb-2">Links to Third Party Sites/Third Party Services</h2>
          <p>
            www.ypropel.com may contain links to other websites ("Linked Sites").
            The Linked Sites are not under the control of YPropel and YPropel is
            ...
            updates to a Linked Site. YPropel is providing these links to you only
            as a convenience, and the inclusion of any link does not imply
            endorsement by YPropel of the site or any association with its
            operators.
          </p>
