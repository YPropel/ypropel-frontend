...
app.put("/users/:id", authenticateToken, asyncHandler(async (req, res) => {
    ...
    const { name, email, title, university, major, experience_level, skills, company, courses_completed, country, state, city, birthdate, volunteering_work, projects_completed, photo_url, } = req.body;
